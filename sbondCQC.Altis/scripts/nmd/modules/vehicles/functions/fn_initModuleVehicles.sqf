	...
	case "preInit": {
...

		{

			{
				...
				_types = [ "O_MRAP_02_F", "B_MRAP_01_F", "C_SUV_01_F", "C_Hatchback_01_sport_F", "B_Heli_Light_01_F", "O_Heli_Light_02_unarmed_F", "I_MRAP_03_F", "O_T_LSV_02_unarmed_F", "B_T_LSV_01_unarmed_F", "C_Van_01_box_F", "B_Truck_01_Repair_F", "B_Truck_01_ammo_F", "O_Truck_03_covered_F", "O_Truck_03_ammo_F2", "O_Heli_Transport_04_F" ];
				_isVehicle = false;
